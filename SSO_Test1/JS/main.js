		...
		if (this.readyState == 4 && this.status == 200) {
			var data = this.response;
              ...
              if(data == "error"){
				...
				window.location.href = "http://ssosite1.live/single_sign_on_test/SSO_Test1/welcome.php";
			  }
		}
	}
...
function logout(){
	...
	xhttp.onreadystatechange = function () {
		if (this.readyState == 4 && this.status == 200) {
				...
				window.location.href = "http://ssosite1.live/single_sign_on_test/SSO_Test1/";
		};
	};
